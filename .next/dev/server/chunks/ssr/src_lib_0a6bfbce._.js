module.exports = [
"[project]/src/lib/supabaseConnection.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabaseConnection.ts [app-ssr] (ecmascript)");
;
    ...
    query: async (sql, params)=>{
        try {
            ...
            if (sqlLower.startsWith('select')) {
                try {
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleSelectQuery"])(sql, params);
                    // Format result to match expected interface
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatResult"])(result);
                } catch (parseError) {
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleInsertQuery"])(sql, params);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatResult"])(result);
            } else if (sqlLower.startsWith('update')) {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleUpdateQuery"])(sql, params);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatResult"])(result);
            } else if (sqlLower.startsWith('delete')) {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleDeleteQuery"])(sql, params);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseConnection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatResult"])(result);
            } else {
...
//# sourceMappingURL=src_lib_0a6bfbce._.js.map