...
"[project]/src/lib/db/reviews.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getReviews(filters) {
  ...
  `;
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(reviewsQuery, params);
    // Get total count
...
async function hasUserReviewedProduct(userId, productId) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM reviews WHERE user_id = $1 AND product_id = $2', [
        userId,
        productId
    ]);
...
async function createReview(review) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO reviews (user_id, product_id, rating, comment, status)
...
async function updateReviewStatus(id, status) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE reviews SET status = $1, updated_at = NOW() WHERE id = $2 RETURNING *`, [
        status,
        id
    ]);
    return result.rows[0] || null;
...
async function deleteReview(id) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM reviews WHERE id = $1', [
        id
    ]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db/reviews.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
async function GET(request) {
    try {
        ...
        if (productId) {
            const reviews = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductReviews"])(productId);
            if (includeRating) {
                const rating = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductRating"])(productId);
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: true,
                    data: {
                        reviews,
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getReviews"])({
...
async function POST(request) {
    try {
        ...
        const hasReviewed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasUserReviewedProduct"])(user.userId, product_id);
        if (hasReviewed) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const review = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$reviews$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createReview"])({
            user_id: user.userId,
            product_id,
            rating,
            comment
...
//# sourceMappingURL=%5Broot-of-the-server%5D__342f4890._.js.map