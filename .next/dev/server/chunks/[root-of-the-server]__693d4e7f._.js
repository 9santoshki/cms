...
async function POST(request) {
    try {
        ...
        try {
            ...
            const { data: users, error } = await supabase.from('users').select('id, email, name, encrypted_password, role, created_at').eq('email', email).single(); // Use single() to get just one user
            if (error || !users) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
            ...
            const isPasswordValid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, users.encrypted_password);
            if (!isPasswordValid) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
                    error: 'Invalid email or password'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__693d4e7f._.js.map