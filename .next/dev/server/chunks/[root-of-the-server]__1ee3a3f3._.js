...
"[project]/src/lib/db/appointments.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createAppointment(appointment) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO appointments (user_id, appointment_date, service_type, notes, status, guest_name, guest_email, guest_phone)
...
async function getAppointmentById(id) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM appointments WHERE id = $1', [
        id
    ]);
    return result.rows[0] || null;
}
async function getAppointmentsByUserId(userId) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT * FROM appointments WHERE user_id = $1 ORDER BY appointment_date DESC`, [
        userId
    ]);
    return result.rows;
}
...
async function updateAppointment(id, updates) {
    ...
    values.push(id);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE appointments SET ${fields.join(', ')}, updated_at = NOW() WHERE id = $${paramCount} RETURNING *`, values);
    return result.rows[0] || null;
}
async function deleteAppointment(id) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM appointments WHERE id = $1', [
        id
    ]);
    return result.rowCount ? result.rowCount > 0 : false;
}
async function updateAppointmentStatus(id, status) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$connection$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE appointments SET status = $1, updated_at = NOW() WHERE id = $2 RETURNING *`, [
        status,
        id
    ]);
    return result.rows[0] || null;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db/appointments.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
async function getUserFromRequest(request) {
    try {
        ...
        const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserProfile"])(session.userId);
        return profile ? {
...
async function GET(request) {
    try {
        ...
        const appointments = user.role === 'admin' || user.role === 'moderator' ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllAppointments"])() : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAppointmentsByUserId"])(user.userId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: appointments
        }, {
...
async function POST(request) {
    try {
        ...
        const appointment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAppointment"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ee3a3f3._.js.map