...
const AppProvider = ({ children })=>{
    ...
    const tempSavedCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
        ...
        "AppProvider.useEffect": ()=>{
            ...
            const initializeAuth = {
                "AppProvider.useEffect.initializeAuth": async ()=>{
                    try {
                        const supabaseUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUser"])();
                        if (isMounted && supabaseUser) {
                            const userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])();
                            if (userProfile) {
                                const userObject = {
                                    id: userProfile.id,
            ...
            initializeAuth();
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChange"])({
                "AppProvider.useEffect.unsubscribe": async (event, session)=>{
    ...
    const fetchCartItems = async ()=>{
        ...
        setError('cart', null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getCartItems();
    ...
    const addToCart = async (product, quantity = 1)=>{
        ...
        if (state.user) {
            ...
            setError('cart', null);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].addToCart(product.id, quantity);
                if (response.success && response.data) {
                    dispatch({
    ...
    const updateCartItem = async (productId, quantity)=>{
        ...
        if (state.user) {
            ...
            setError('cart', null);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].updateCartItem(productId, quantity);
                if (response.success && response.data) {
    ...
    const removeFromCart = async (productId)=>{
        ...
        if (state.user) {
            ...
            setError('cart', null);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].removeFromCart(productId);
                if (response.success) {
                    dispatch({
                        type: ACTIONS.REMOVE_FROM_CART,
                        payload: productId
    ...
    const clearCart = async ()=>{
        if (state.user) {
            ...
            setError('cart', null);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].clearCart();
                if (response.success) {
                    dispatch({
    ...
    const logout = async ()=>{
        try {
            ...
            try {
                const { signOut } = await __turbopack_context__.A("[project]/src/lib/supabase/auth.ts [app-client] (ecmascript, async loader)");
                await signOut();
            ...
            try {
                const { apiClient } = await __turbopack_context__.A("[project]/src/lib/api.ts [app-client] (ecmascript, async loader)");
    ...
    const updateProduct = async (id, productData)=>{
        ...
        setError('products', null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].updateProduct(id, productData);
            if (response.success && response.data) {
    ...
    const fetchProductBySlug = async (slug)=>{
        ...
        setError('products', null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getProductBySlug(slug);
            if (response.success && response.data) {
    ...
    const searchProducts = async (params)=>{
        ...
        setError('products', null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].searchProducts(params);
            if (response.success && response.data) {
    ...
    const fetchAppointments = async (filters)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getAppointments(filters);
            if (response.success && response.data) {
                dispatch({
    ...
    const updateAppointment = async (id, updateData)=>{
        if (!state.user) return;
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].updateAppointment(id, updateData);
            if (response.success && response.data) {
...
_s(AppProvider, "l/PsYCpYaChqy61SQhoFnKVk1ow=");
_c = AppProvider;
const useAppContext = ()=>{
    _s1();
...
"[project]/src/lib/supabase/SessionContextProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SessionContextProvider({ supabaseClient, children }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SessionContextProvider.useEffect": ()=>{
            const getInitialSession = {
                "SessionContextProvider.useEffect.getInitialSession": async ()=>{
                    setLoading(true);
                    ...
                    const { data: { subscription } } = await supabaseClient.auth.onAuthStateChange({
                        "SessionContextProvider.useEffect.getInitialSession": async (_event, session)=>{
                            setSession(session);
                            setUser(session?.user || null);
                            if (session?.user) {
                                // Fetch user profile from profiles table
                    ...
                    }["SessionContextProvider.useEffect.getInitialSession"]);
                    return ({
                        "SessionContextProvider.useEffect.getInitialSession": ()=>{
                            subscription.unsubscribe();
                        }
...
_s(SessionContextProvider, "irauaxMOEWjG1lICmTthQs+tY9I=");
_c = SessionContextProvider;
...
_s1(useSessionContext, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "SessionContextProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/NextAuthProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$SessionContextProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase/SessionContextProvider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase/client.ts [app-client] (ecmascript)");
'use client';
;
;
...
function NextAuthProvider({ children }) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$SessionContextProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SessionContextProvider"], {
...
//# sourceMappingURL=src_e9e0c001._.js.map