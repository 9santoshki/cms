...
const AppProvider = ({ children })=>{
    ...
    const login = async (credentials)=>{
        ...
        try {
            ...
            if (response.success && response.data) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].setToken(response.data.token);
    ...
    const register = async (userData)=>{
        ...
        setError('auth', null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].register(userData);
            if (response.success && response.data) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].setToken(response.data.token);
                setToken(response.data.token);
                setUser(response.data.user);
...
_s(AppProvider, "ChsHAiHBZcD1UGPekEfyxwFARD8=");
_c = AppProvider;
const useAppContext = ()=>{
    _s1();
...
//# sourceMappingURL=src_237d0942._.js.map