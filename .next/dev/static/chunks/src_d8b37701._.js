...
const AuthProvider = ({ children })=>{
    ...
    const logout = async ()=>{
        try {
            ...
            await __turbopack_context__.A("[project]/src/lib/supabase/auth.ts [app-client] (ecmascript, async loader)").then(async ({ signOut })=>{
                await signOut();
            });
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "AuthProvider.useEffect": ()=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                __turbopack_context__.A("[project]/src/lib/supabase/auth.ts [app-client] (ecmascript, async loader)").then({
                    "AuthProvider.useEffect": ({ onAuthStateChange, getCurrentUser, getUserProfile })=>{
                        const subscription = onAuthStateChange({
                            "AuthProvider.useEffect.subscription": async (event, session)=>{
                        ...
                        }["AuthProvider.useEffect.subscription"]);
...
//# sourceMappingURL=src_d8b37701._.js.map