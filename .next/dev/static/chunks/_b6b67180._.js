                ...
                "AuthCallback.useEffect.handleAuthCallback": async ()=>{
                    ...
                    if (error) {
                        ...
                        if (error === 'access_denied') {
                            ...
                            }["AuthCallback.useEffect.handleAuthCallback"], 1500);
                        } else {
                            // Other OAuth errors
                            ...
                            }["AuthCallback.useEffect.handleAuthCallback"], 2000);
                        }
                        return;
                    }
                    if (code) {
...
_s(AuthCallback, "jug5OEZhY/9KWQ25z6mQBlU9tag=", false, function() {
    return [
