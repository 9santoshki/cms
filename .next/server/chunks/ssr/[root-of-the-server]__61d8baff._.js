...
`,k=g.default.button`
  padding: 14px 28px;
  background-color: ${a=>a.$active?"#c19a6b":"transparent"};
  color: ${a=>a.$active?"white":"#c19a6b"};
...
`;a.s(["default",0,()=>{let{user:a}=(0,d.useAppContext)(),[g,w]=(0,c.useState)("All"),[x,y]=(0,c.useState)([]),[z,A]=(0,c.useState)(!0);(0,c.useEffect)(()=>{y([{id:1,title:"Modern Minimalist Living Room",category:"Residential",description:"Clean lines and contemporary aesthetics with a focus on functionality and natural light.",imageClass:"modern"},{id:2,title:"Classic Elegance Dining Space",category:"Residential",description:"Timeless designs with refined details featuring rich textures and elegant furnishings.",imageClass:"classic"},{id:3,title:"Coastal Retreat Bedroom",category:"Residential",description:"Light, airy spaces with natural elements and soothing color palettes inspired by the ocean.",imageClass:"coastal"},{id:4,title:"Corporate Office Design",category:"Commercial",description:"Professional workspace that balances productivity with comfort and aesthetic appeal.",imageClass:"office"},{id:5,title:"Boutique Hotel Lobby",category:"Hospitality",description:"Luxurious and inviting space that creates a memorable first impression for guests.",imageClass:"hotel"},{id:6,title:"Restaurant Interior",category:"Commercial",description:"Atmospheric dining environment that enhances the culinary experience.",imageClass:"restaurant"}]),A(!1)},[]);let B="All"===g?x:x.filter(a=>a.category===g);return z?(0,b.jsx)(h,{children:(0,b.jsx)(v,{})}):(0,b.jsxs)(h,{children:[(0,b.jsx)(e.default,{activePage:"portfolio"}),(0,b.jsx)(i,{children:(0,b.jsxs)("div",{className:"hero-content",children:[(0,b.jsx)("h1",{children:"Design Portfolio"}),(0,b.jsx)("p",{children:"Showcasing our finest interior design projects across residential, commercial, and hospitality spaces."})]})}),(0,b.jsx)(j,{children:(0,b.jsx)("div",{className:"filter-container",children:(0,b.jsx)("div",{className:"filter-buttons",children:["All","Residential","Commercial","Hospitality"].map(a=>(0,b.jsx)(k,{$active:g===a,onClick:()=>w(a),children:a},a))})})}),(0,b.jsx)(l,{children:(0,b.jsx)("div",{className:"projects-container",children:B.length>0?(0,b.jsx)("div",{className:"projects-grid",children:B.map(a=>(0,b.jsxs)(m,{children:[(0,b.jsx)(n,{imageClass:a.imageClass}),(0,b.jsx)(o,{children:(0,b.jsxs)(p,{children:[(0,b.jsx)(q,{children:a.category}),(0,b.jsx)(r,{children:a.title}),(0,b.jsx)(s,{children:a.description}),(0,b.jsx)(t,{children:"View Project"})]})})]},a.id))}):(0,b.jsx)("div",{className:"no-projects",children:(0,b.jsx)("h3",{children:"No projects found for this category"})})})}),(0,b.jsx)(u,{children:(0,b.jsxs)("div",{className:"cta-content",children:[(0,b.jsx)("h2",{children:"Ready to Transform Your Space?"}),(0,b.jsx)("p",{children:"Let our expert designers create a space that reflects your unique style and meets your needs."}),(0,b.jsx)("button",{className:"cta-button",children:"Schedule a Consultation"})]})}),(0,b.jsx)(f.default,{})]})}],99177)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__61d8baff._.js.map